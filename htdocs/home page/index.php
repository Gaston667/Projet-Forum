    ...
    <nav class="navbar">
        <div class="max-width">
            ...
            <ul class="menu">
                ...
                <li><a href="#services" class="menu-btn">Dernier-post</a></li>
     ...
     <section class="teams" id="teams">
        <div class="max-width">
            ...
            <div class="carousel owl-carousel">
                ...
                <div class="card">
                    <div class="box">
                        <video autoplay muted="" loop="infinite"  src="../img/Gnogué (1).mp4"></video>
                ...
                <div class="card">
                    <div class="box">
                        <video autoplay muted="" loop="infinite" src="../img/Gnogué (2).mp4"></video>
